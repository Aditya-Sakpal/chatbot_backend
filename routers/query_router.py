...
from utils.constants import QUERY_CLASSIFICATION_USER_PROMPT, QUERY_CLASSIFICATION_SYSTEM_PROMPT , GREET_USER_PROMPT , GREET_SYSTEM_PROMPT \
    , RESPONSE_GENERATION_USER_PROMPT , RESPONSE_GENERATION_SYSTEM_PROMPT
...
async def query(request: QueryRequest):
    try:
        ...
        if type == "garbage":
            ...
            messages = request.messages.append(
                {
                    "role": "system",
